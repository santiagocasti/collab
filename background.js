...
promise.then(function () {
    ...
    switch (peerReplicationProtocol) {
        ...
        case TreeOverlay:
            ...
            break;
        case GoogleRealtimeAPI:
            /**
             * Google Realtime API
             */
            var googleRealtime = new GoogleRealtimeAPI();
            comm.setPeerReplicationProtocol(googleRealtime);
            debug("Starting the Google Realtime API protocol....");
